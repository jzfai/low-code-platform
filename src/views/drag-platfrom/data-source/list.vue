  ...
  <div class="p-10px">
    <el-form v-show="showSearch" :model="queryParams" :inline="true" label-width="68px">
      ...
      <el-form-item label="平台名称" prop="platName">
        <el-input
          v-model.trim="queryParams.platName"
          placeholder="请输入平台名称"
          clearable
          class="wi-150px"
          @keyup.enter="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <ColumnFilter v-if="dataSourceList.length" :is-operation="true" :cols="tableHeadColumns" @colChange="colChange" />
    </el-row>
    <el-table
      ref="refElTable"
      v-loading="loading"
...
import { listReq } from '@/api/dataSource'
//导入当前页面封装方法
